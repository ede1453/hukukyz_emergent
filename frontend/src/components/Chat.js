    ...
    <div className="flex flex-col bg-gray-900" style={{ height: '100vh' }}>
      <div className="bg-gray-800 border-b border-gray-700 p-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          {/* Credit Widget for non-admin users */}
          {!isUserAdmin && creditBalance !== null && (
            <div className="bg-gray-900 border border-gray-600 rounded-lg px-4 py-2">
              <p className="text-xs text-gray-400">Kalan Kredi</p>
              <p className="text-lg font-bold text-yellow-400">{creditBalance.toFixed(2)}</p>
            </div>
          )}
          ...
          {isUserAdmin && (
            <div className="bg-blue-900 border border-blue-600 rounded-lg px-4 py-2">
              ...
              <p className="text-sm text-blue-400">Sınırsız Kredi</p>
            </div>
          )}
        </div>
      </div>
